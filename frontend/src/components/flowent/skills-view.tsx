        ...
        {skills.map((skill) => {
          ...
          return (
            <Button
              ...
              className={cn(
                "grid h-auto min-h-9 w-full cursor-pointer justify-start rounded-[10px] border border-transparent bg-transparent px-2.5 py-1.5 text-left text-white shadow-none transition-colors duration-100 hover:bg-[#171717]",
                navigationLabelClassName,
                isActive && "bg-[#2f2f2f]",
              )}
              key={skill.id}

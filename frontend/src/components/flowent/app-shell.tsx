...
function WorkflowNavigationItem({
  ...
  return (
    <Button
      className={cn(
        "flowent-navigation-item w-full cursor-pointer justify-start gap-2 rounded-lg border border-transparent bg-transparent px-2 py-1 text-white/90 shadow-none transition-colors duration-100 hover:bg-[#151515] hover:text-white max-[900px]:justify-center max-[560px]:min-w-fit max-[560px]:flex-none max-[560px]:px-2 max-[560px]:[&_svg]:hidden [&_svg]:text-current",
        navigationLabelClassName,
...
export function AppShell({
  ...
  return (
    <Tabs
      ...
      className="grid h-[var(--flowent-viewport-height)] min-h-0 grid-cols-[232px_minmax(0,1fr)] gap-0 overflow-hidden bg-black pt-[var(--flowent-safe-area-top)] pr-[var(--flowent-safe-area-right)] pb-[var(--flowent-safe-area-bottom)] pl-[var(--flowent-safe-area-left)] text-white max-[900px]:grid-cols-1 max-[900px]:grid-rows-[auto_minmax(0,1fr)]"
    >
      <aside className="flex min-h-0 flex-col border-r border-white/10 bg-black px-3 py-3 max-[900px]:min-h-auto max-[900px]:border-r-0 max-[900px]:border-b max-[900px]:px-3 max-[900px]:py-3">
        <div className="flex min-h-10 items-center gap-2.5 bg-black px-1 max-[560px]:min-h-10">
        ...
        <nav aria-label="Primary navigation">
          <TabsList
            className="mt-4 -mx-1 flex w-auto flex-none flex-col items-stretch gap-0 p-0 max-[900px]:mt-3 max-[900px]:mx-0 max-[900px]:flex-row max-[560px]:justify-start max-[560px]:overflow-x-auto"
            variant="line"
          >
            ...
            <div
              aria-hidden="true"
              className="mt-4 mb-1 flex items-center gap-1.5 px-2 text-[11px] leading-4 font-medium text-white/45 max-[900px]:hidden"
            >
        ...
        <div className="mt-auto -mx-1 flex h-8 items-center gap-2 px-2 text-xs text-[#9b9b9b] max-[900px]:hidden">
          <div

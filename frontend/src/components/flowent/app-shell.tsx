    ...
    >
      ...
      >
        ...
        <Button
          ...
          className="absolute top-0 right-[-4px] z-10 hidden h-full w-2 cursor-ew-resize rounded-none border-0 bg-transparent p-0 shadow-none transition-colors hover:bg-white/10 focus-visible:border-transparent focus-visible:bg-white/10 focus-visible:ring-0 focus-visible:outline-none active:border-transparent active:not-aria-[haspopup]:translate-y-0 max-[900px]:hidden sm:block"
          onClick={toggleSidebar}
          tabIndex={-1}

...
from huddol.diagnostics import log_event, log_exception, register_secret
...
from huddol.runtime import (
    AgentRunContext,
    AgentRunFailure,
    AgentRunner,
    AgentRunOutcome,
)
from huddol.todos import unwrap_tool_result
...
class PydanticAgentRunner:
    ...
    async def run_async(
        ...
        if api_type == "openai-responses":
            model_settings = {
                "openai_prompt_cache_key": f"huddol-agent-{reminder.agent_id}",

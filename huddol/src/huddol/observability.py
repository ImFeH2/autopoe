...
from huddol.domain import Reminder
...
class ReminderTrace:
    ...
    def create(cls, reminder: Reminder) -> ReminderTrace:
        ...
        return cls(
            ...
            session_id=f"huddol-agent-{reminder.agent_id}",
        )

    def run_metadata(self) -> dict[str, str | int]:
        return {
            "huddol.agent.id": self.agent_id,
            "huddol.discussion.ids": self.discussion_ids,
            "huddol.message.count": self.message_count,
        }

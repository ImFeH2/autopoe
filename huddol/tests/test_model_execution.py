...
from huddol.model_execution import (
    ModelExecutionLoop,
    ModelRequestLimiter,
    ModelRequestPolicy,
    RetryingModel,
)
from huddol.model_runner import ModelConfig, ModelRuntime, PydanticAgentRunner
from huddol.persistence import SQLiteStore
from huddol.runtime import AgentRunFailure, AgentRunOutcome
...
def test_model_request_policy_exhausts_one_huddol_retry(tmp_path: Path) -> None:
    attempts = 0
    delays: list[float] = []

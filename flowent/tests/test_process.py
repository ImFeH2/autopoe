...
def test_agent_model_history_continues_across_process_restarts(
    ...
    (support / "sitecustomize.py").write_text(
        ...
        "        context.discussion('read', discussion_id=activation.discussion_id, "
        "end_message_id=activation.message_id)\n"
        "        context.discussion('send', discussion_id=activation.discussion_id, "
        "body=f'Inherited {previous} model messages')\n"
        "        context.discussion('ack', discussion_id=activation.discussion_id, "
